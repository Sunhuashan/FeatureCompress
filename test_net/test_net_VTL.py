...
from dataset import VTLDataSet
from tensorboardX import SummaryWriter
from plt.vtl_draw_points import vtldrawplt
...
def testvtl(global_step, testfull=False):
    with torch.no_grad():
        ...
        vtldrawplt([sumbpp], [sumpsnr], [summsssim], global_step, testfull=testfull)
...
if __name__ == "__main__":
    ...
    if args.testvtl:
        ...
        print('testing VTL')
        testvtl(global_step, testfull=True)
        exit(0)
