...
class FVC_base(nn.Module):
    def __init__(self,):
        ...
        self.mode_prediction_network = mode_prediction_network(in_planes=out_channel_M, out_planes=out_channel_M)
        ...
        self.motion_hyperprior_HAMC = Hyperprior_mv(planes=out_channel_M, mid_planes=out_channel_M)
    ...
    def forward(self,input_image, referframe):
        ...
        offset_hat, motion_likelihoods = self.motion_hyperprior_HAMC(offset)
        # decode motion info
        ...
        return clipped_recon_image, mse_loss,  bpp_res, bpp_resprior, bpp_mv, bpp_mvprior, bpp
